...
[0:0] -A %(bn)s-o_port1 -s 0.0.0.0/32 -d 255.255.255.255/32 -p udp -m udp \
...
[0:0] -A %(bn)s-o_%(port1)s -s 0.0.0.0/32 -d 255.255.255.255/32 -p udp -m udp \
--sport 68 --dport 67 -j RETURN
...
[0:0] -A %(bn)s-o_%(port2)s -s 0.0.0.0/32 -d 255.255.255.255/32 -p udp -m udp \
--sport 68 --dport 67 -j RETURN
