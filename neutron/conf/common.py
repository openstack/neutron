...
core_opts = [
    ...
    cfg.StrOpt('setproctitle',
               default='on',
               choices=[('off', 'retains the previous behavior'),
                        ('on', 'renames processes to \'neutron-server: role '
                               '(original string)\''),
                        ('brief', 'renames the same as \'on\', but without '
                                  'the original string, such as '
                                  '\'neutron-server: role\'')],
