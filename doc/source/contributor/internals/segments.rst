...
Details about the DB models, API extension, and use cases can be found here: `routed networks spec <https://specs.openstack.org/openstack/neutron-specs/specs/newton/routed-networks.html>`_
